    ...
    askTemplates: () => {
        const questions = [
            ...
            },
            {
                ...
                type: 'list',
                choices: ['7','10 (BETA)', '11 (Module Federation BETA)'],
                ...
                filter: (val =>  {
                    switch(val){
                        case '10 (BETA)':
                            return '10';
                            break;
                        case '11 (Module Federation BETA)':
                            return '11';
                            break;
                        default:
                            return val;
                ...
                when: (answers => answers.useClient && answers.clientFramework === 'angular'),
                validate: function(value) {
                    if (value.length) {
                        return true;
                    } else {
            ...
            },
            {
                name: 'useCpi',
                type: 'confirm',
                message: 'Would you like to use cpi-side?'
            }
        ];
        return inquirer.prompt(questions);
    },
