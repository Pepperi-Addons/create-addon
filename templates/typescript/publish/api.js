...
var MyService = /** @class */ (function () {
    function MyService(client) {
        this.client = client;
    }
    MyService.prototype.doSomething = function () {
        console.log("doesn't really do anything....");
    };
    MyService.prototype.getAddons = function () {
        var headers = { authorization: 'Bearer ' + this.client.OAuthAccessToken };
        var options = {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, service.getAddons()];
                case 1:
                    res = _a.sent();
                    return [2 /*return*/, res];
            }
...
function js_foo$1(client, request) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api2.js_foo(client, request)];
        });
    });
}
